...
public class RailCraftRecipes {
    ...
    public static void loadRecipes(String modName) {
        ...
        for (ItemStack coke : coalCoke) {
            ...
            TransmutationHelper.addRecipe(coke, new Object[]{(new ItemStack(Items.coal, 1, 1)), (new ItemStack(Items.coal, 1, 1)), (new ItemStack(Items.coal, 1, 1)),
                    (new ItemStack(Items.coal, 1, 1))});
            // 1 Coal Coke -> 4 Coal/CharCoal
            TransmutationHelper.addRecipe(new ItemStack(Items.coal, 4, 1), new Object[]{coke});
        }
    }
}
