...
public class VanillaRecipes {
    ...
    public static void loadRecipes() {
        ...
        TransmutationHelper.addRecipe((new ItemStack(Block.glass, 3)), new Object[] { Block.thinGlass, Block.thinGlass, Block.thinGlass, Block.thinGlass, Block.thinGlass,
        ...
        // 8 Coal -> 1 Lapis
        TransmutationHelper.addRecipe((new ItemStack(Item.dyePowder, 1, 4)), new Object[] { (new ItemStack(Item.coal, 1, WILDCARD)), (new ItemStack(Item.coal, 1, WILDCARD)),
        ...
        // 2 Lapis -> 16 Coal
        TransmutationHelper.addRecipe(new ItemStack(Item.coal, 16), new Object[] { (new ItemStack(Item.dyePowder, 1, 4)), (new ItemStack(Item.dyePowder, 1, 4)) });

        if (ModVars.emeraldTransmute) {
            // 8 Gold Ingot -> 1 Emerald
            TransmutationHelper.addRecipe(Item.emerald, new Object[] { Item.ingotGold, Item.ingotGold, Item.ingotGold, Item.ingotGold, Item.ingotGold, Item.ingotGold,
        ...
        TransmutationHelper.addRecipe(Item.ingotIron, new Object[] { Item.netherQuartz, Item.netherQuartz, Item.netherQuartz, Item.netherQuartz });

        TransmutationHelper.addRecipe(new ItemStack(Item.netherQuartz, 4), new Object[] { Item.ingotIron, Item.ingotIron, Item.ingotIron });

        // 5 Blaze rods -> 1 Diamond Disabled due to exploit
        if (ModVars.blazeTransmute)
            TransmutationHelper.addRecipe(Item.diamond, new Object[] { Item.blazeRod, Item.blazeRod, Item.blazeRod, Item.blazeRod, Item.blazeRod });
