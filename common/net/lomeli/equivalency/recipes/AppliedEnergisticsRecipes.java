...
public class AppliedEnergisticsRecipes {
    public static void loadRecipes(ItemStack transmutationStone, String modName) {
        ...
        TransmutationHelper.addRecipe(
                new ItemStack(Materials.matQuartzDust.getItem(), 10, 7),
        ...
        TransmutationHelper.addRecipe(
                new ItemStack(Materials.matQuartz.getItem(), 1, 6),
                transmutationStone, new Object[] { iron, iron });

        // 1 Quartz Crystal -> 2 Iron
        TransmutationHelper.addRecipe(new ItemStack(iron.getItem(), 2),
                transmutationStone, new Object[] { Materials.matQuartz });
        ...
        for (int j = 0; j < k; j++) {
            if (j == (k - 1))
                TransmutationHelper.addRecipe(Blocks.blkCable_Colored[0],
                        transmutationStone,
                        new Object[] { Blocks.blkCable_Colored[j] });
            else
                TransmutationHelper.addRecipe(Blocks.blkCable_Colored[j + 1],
                        transmutationStone,
                        new Object[] { Blocks.blkCable_Colored[j] });
        }
    }
