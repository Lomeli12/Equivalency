...
public class DartCraftRecipes {
	...
	public static void loadRecipes(ItemStack transmutationStone){
		...
		//3 Force Gem <=> 6 Force Ingot
		TransmutationHelper.addRecipe(new ShapelessOreRecipe(new ItemStack(ingotForce.getItem(), 6, 
			ingotForce.getItemDamage()), transmutationStone, forceGem, forceGem, forceGem));
		TransmutationHelper.addRecipe(new ShapelessOreRecipe(new ItemStack(forceGem.getItem(), 3, 
