...
public class TERecipes {
    ...
    public static void loadRecipes(ItemStack transmutationStone, String modName) {
        ...
        // 3 Lead = 1 Electrum
        TransmutationHelper.addRecipe(new ShapelessOreRecipe(electrumIngot, transmutationStone, "ingotLead", "ingotLead",
                "ingotLead"));
        // 1 Electrum = 3 Lead
        TransmutationHelper.addRecipe(new ShapelessOreRecipe(new ItemStack(leadIngot.getItem(), 3, leadIngot.getItemDamage()),
                transmutationStone, "ingotElectrum"));

        TransmutationHelper.addRecipe(new ShapelessOreRecipe(new ItemStack(invarIngot.getItem(), 3, invarIngot.getItemDamage()),
                transmutationStone, "ingotNickel", "ingotNickel"));

        TransmutationHelper.addRecipe(new ShapelessOreRecipe(
                new ItemStack(ingotNickel.getItem(), 2, ingotNickel.getItemDamage()), transmutationStone, "ingotInvar",
                "ingotInvar", "ingotInvar"));

        TransmutationHelper.addRecipe(new ShapelessOreRecipe(ingotNickel, transmutationStone, "ingotLead", "ingotLead"));

        TransmutationHelper.addRecipe(new ShapelessOreRecipe(new ItemStack(leadIngot.getItem(), 2, leadIngot.getItemDamage()),
