...
public class MagiksRecipes {
    ...
    public static void loadRecipes(ItemStack transmutationStone) {
        ...
        TransmutationHelper.addRecipe(igniousIngot, transmutationStone,
                new Object[] { stamaticIngot, stamaticIngot, stamaticIngot,
                        stamaticIngot });

        TransmutationHelper.addRecipe(
                new ItemStack(stamaticIngot.getItem(), 4), transmutationStone,
                new Object[] { igniousIngot });

        TransmutationHelper.addRecipe(igniousBlock, transmutationStone,
                new Object[] { stamaticBlock, stamaticBlock, stamaticBlock,
                        stamaticBlock });

        TransmutationHelper.addRecipe(
                new ItemStack(stamaticBlock.getItem(), 4), transmutationStone,
                new Object[] { igniousBlock });

        TransmutationHelper.addRecipe(manceryBlock, transmutationStone,
                new Object[] { manceryBrick });
        TransmutationHelper.addRecipe(manceryBrick, transmutationStone,
                new Object[] { manceryBlock });

        TransmutationHelper.addRecipe(neoniteGem, transmutationStone,
                new Object[] { Item.emerald, Item.emerald });
        TransmutationHelper.addRecipe(new ItemStack(Item.emerald, 2),
                transmutationStone, new Object[] { neoniteGem });

        TransmutationHelper.addRecipe(neoniteBlock, transmutationStone,
                new Object[] { Block.blockEmerald, Block.blockEmerald });
        TransmutationHelper.addRecipe(new ItemStack(Block.blockEmerald, 2),
                transmutationStone, new Object[] { neoniteBlock });
